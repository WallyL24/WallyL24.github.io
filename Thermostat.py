...
class TemperatureMachine(StateMachine):
    ...
    def on_enter_heat(self):
        ##
        ## Update the heat lights on the thermostat. 
        redLight.pulse()
    ...
    def on_enter_cool(self):
        ##
        ## Update the colling lights on the thermostat.
        blueLight.pulse()
    ...
    def processTempIncButton(self):
        ...
        ##
        ## Updates the setPoint of the thermostat and the status lights
        self.setPoint += 1
        self.updateLights()
    ...
    def updateLights(self):
        ...
        ##
        ## Updates the status lights in our thermostat circuit for heating and cooling
    ...
    def setupSerialOutput(self):
        ##
        ## String creates output with current temp
    ...
    def manageMyDisplay(self):
        ...
        while not self.endDisplay:
            ...
            if(altCounter < 6):
                ##
                ## of the LCD display to incude the current temperature in degrees Fahrenheit. 
                lcd_line_2 = f"Temp: {floor(self.getFahrenheit())}F"
    
                altCounter = altCounter + 1
            else:
                ##
                ## displays current state of the thermostat and the current temperature setpoint in 
                ## degrees Fahrenheit. 
            ...
            if((counter % 30) == 0):
                ##
                ## sends current state information to the TemperatureServer over the Serial Port (UART).
...
##
## Button press switches beatween off, heating, and cooling
...
redButton = Button(25)
##
## red button press increases the heat
...
##
## blue button press decreases the temp
